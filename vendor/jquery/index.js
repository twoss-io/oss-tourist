...
function genBlogElm(obj, nowPage, perNum, category) {
    ...
    html += '<h2 class="text-center">Blog</h2><hr class="hr_w">' ;
    ...
    for (var i in obj) {
      ...
      html +=   '<span style= "padding:0px 8px">Blog Page '+ nowPage + '/' + totalPage +'</span>' ;
...
function genSlideElm(obj, nowPage, perNum, category) {
    ...
    var end = nowPage * perNum ; // 根據頁數之結束數 e.g 第一頁6 第二頁12個   
    var nowPassNum = 0; // 已經找到之其類別的個數
    html += '<h2 class="text-center">Slide</h2><hr class="hr_w">' ;
    //console.log('genBlogElm obj:'+obj);
    for (var i in obj) {
        var desvalue = '';
        var ttlvalue = '';
      ...
      html += '<div style = "width:80%;padding:0px 0px 10px; margin:auto;">'
      html +=   '<span style= "padding:0px 8px">Slide Page '+ nowPage + '/' + totalPage +'</span>' ;
...
function genVideoElm(obj, nowPage, perNum, category) {
    ...
    var end = nowPage * perNum ; // 根據頁數之結束數 e.g 第一頁6 第二頁12個   
    var nowPassNum = 0; // 已經找到之其類別的個數
    html += '<h2 class="text-center">Video</h2><hr class="hr_w">' ;
    //console.log('genBlogElm obj:'+obj);
    for ( var i in obj) {
        var desvalue = '';
        var ttlvalue = '';
      ...
      html += '<div style = "width:80%;padding:0px 0px 10px; margin:auto;">'
      html +=   '<span style= "padding:0px 8px">Video Page '+ nowPage + '/' + totalPage +'</span>' ;
